package com.example.muraseyuuichirou.mytoratora;
...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (id) {
            case R.id.gu:
                myHandImageView.setImageResource(R.drawable.nigaoe_katoukiyomasa);
                myHand = JANKEN_GU;
                break;
            case R.id.choki:
                myHandImageView.setImageResource(R.drawable.animalface_tora);
                myHand = JANKEN_CHOKI;
                break;
            case R.id.pa:
                myHandImageView.setImageResource(R.drawable.images);
                myHand = JANKEN_PA;
                break;
            default:
                myHand = JANKEN_GU;
        ...
        switch (comHand) {
            case JANKEN_GU:
                comHandImageView.setImageResource(R.drawable.nigaoe_katoukiyomasa);
                break;
            case JANKEN_CHOKI:
                comHandImageView.setImageResource(R.drawable.animalface_tora);
                break;
            case JANKEN_PA:
                comHandImageView.setImageResource(R.drawable.images);
                break;
        }
        ...
        switch (gameResult) {
            case 0:
                resultLabel.setText("あいこです");
                break;
            case 1:
                resultLabel.setText("あなたの勝ちです");
                break;
            case 2:
                resultLabel.setText("コンピュータの勝ちです");
                break;
        }
